...
export default function TrackingPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      {/* Header Banner */}
      <div className="p-6 rounded-xl bg-surface-container-low border border-primary/20 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl bg-primary/10 border border-primary/30 flex items-center justify-center text-primary glow-cyan shrink-0">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded text-label-sm font-code-metric bg-tertiary/10 text-tertiary border border-tertiary/30">
        ...
        <div className="flex flex-wrap items-center gap-2.5 shrink-0">
          <button
            ...
            className="px-3.5 py-2 rounded-lg bg-primary-container hover:bg-primary text-on-primary-container text-xs font-semibold flex items-center gap-1.5 cursor-pointer transition-all shadow-[0_0_15px_rgba(6,182,212,0.25)]"
          >
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-lg bg-surface-container-high hover:bg-surface-container hover:text-primary border border-outline-variant/40 text-on-surface text-xs font-medium flex items-center gap-1.5 cursor-pointer transition-colors"
          >
          ...
          <button
            type="button"
            onClick={loadData}
            className="p-2 rounded-lg bg-surface-container-high hover:bg-surface-container border border-outline-variant/40 text-on-surface hover:text-primary transition-colors cursor-pointer"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 font-code-metric">
        ...
        <div className="p-4 rounded-xl bg-surface-container-low border border-outline-variant/30 space-y-1">
          <span className="text-[11px] text-on-surface-variant flex items-center gap-1">
            <Radio className="w-3.5 h-3.5 text-primary" /> Total Kontak Tersimpan
          </span>
          <div className="flex items-baseline justify-between">
            <span className="text-2xl font-bold text-on-surface">{totalLeads}</span>
        ...
        <div className="p-4 rounded-xl bg-surface-container-low border border-tertiary/30 space-y-1">
          <span className="text-[11px] text-tertiary flex items-center gap-1">
            <Zap className="w-3.5 h-3.5" /> Event 1: {settings.event_1_name}
          </span>
          <div className="flex items-baseline justify-between">
            <span className="text-2xl font-bold text-tertiary">{event1Sent}</span>
        ...
        <div className="p-4 rounded-xl bg-surface-container-low border border-outline-variant/30 space-y-1">
          <span className="text-[11px] text-on-surface-variant flex items-center gap-1">
            <Layers className="w-3.5 h-3.5 text-primary" /> Event 2 &amp; 3 (Mid-Funnel)
          </span>
          <div className="flex items-baseline justify-between">
          ...
          <p className="text-[10px] text-outline">{settings.event_2_name} &amp; {settings.event_3_name}</p>
        </div>

        {/* Metric 4: Purchase (Event 4) */}
        <div className="p-4 rounded-xl bg-surface-container-low border border-outline-variant/30 space-y-1">
          <span className="text-[11px] text-on-surface-variant flex items-center gap-1">
            <DollarSign className="w-3.5 h-3.5 text-tertiary" /> Event 4: {settings.event_4_name}
          </span>
          <div className="flex items-baseline justify-between">
            <span className="text-2xl font-bold text-on-surface">
      ...
      <div className="px-4 py-3 rounded-lg bg-surface-container-lowest border border-outline-variant/30 flex flex-wrap items-center justify-between gap-3 text-xs font-code-metric">
        <div className="flex flex-wrap items-center gap-4">
          <div className="flex items-center gap-1.5">
            <Database className="w-4 h-4 text-primary" />
            <span className="text-outline">Meta CAPI Dataset ID:</span>
            <span className="text-primary font-bold">{settings.dataset_id || "1469138511709885"}</span>
        ...
        <div className="flex items-center gap-2">
          ...
          {settings.test_code && (
            <span className="ml-2 px-1.5 py-0.5 rounded bg-amber-400/10 text-amber-400 border border-amber-400/20 text-[10px]">
      ...
      {/* MAIN TRACKING TABLE (4 Event Columns) */}
                  ...
                  <td colSpan={7} className="py-12 text-center text-on-surface-variant">
                    <div className="max-w-md mx-auto space-y-2">
                      ...
                      <p className="text-xs text-outline leading-relaxed">
                        Data nomor WhatsApp dan Click ID (<code className="font-mono text-primary">ctwa_clid</code>) akan tersimpan secara otomatis di database ketika ada pesan masuk dari iklan WhatsApp Meta Ads, atau Anda dapat mengujinya dengan tombol <strong className="text-primary">+ Simulasi Pesan Masuk Iklan</strong> di atas.
                      </p>
                    </div>
                  </td>
                </tr>
                ...
                leads.map((lead) => {
                  return (
                    <tr key={lead.id} className="hover:bg-surface-container transition-colors">
                      ...
                      {/* 3. Kolom Event 1 (Otomatis saat pesan pertama masuk) */}
                      ...
                      {/* 4. Kolom Event 2 (Manual dipilih oleh user) */}
                      <td className="py-3 px-3">
                        <div className="space-y-1.5 min-w-[145px]">
                          <select
                      ...
                      {/* 5. Kolom Event 3 (Manual dipilih oleh user) */}
                      <td className="py-3 px-3">
                        <div className="space-y-1.5 min-w-[145px]">
                          <select
                      ...
                      {/* 6. Kolom Event 4 (Manual dipilih oleh user) */}
                      <td className="py-3 px-3">
      ...
      <div className="p-5 rounded-xl bg-surface-container-low border border-outline-variant/30 space-y-4">
        <div className="flex items-center justify-between pb-2 border-b border-outline-variant/20">
          <div className="flex items-center gap-2 text-on-surface">
            <Radio className="w-4 h-4 text-tertiary animate-pulse" />
          ...
          <button
            ...
            className="text-xs text-primary hover:underline flex items-center gap-1 cursor-pointer font-code-metric"
          >
      ...
      {showSettingsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm p-4">
          <div className="w-full max-w-lg rounded-xl bg-surface-container-lowest border border-outline-variant/50 p-6 space-y-5 shadow-2xl">
            <div className="flex items-center justify-between pb-2 border-b border-outline-variant/20">
            ...
            <form onSubmit={handleSaveSettings} className="space-y-4 text-xs font-sans">
              ...
              <div className="p-3.5 rounded-lg bg-surface-container-low border border-primary/30 space-y-2.5">
                <div className="flex items-center justify-between">
                  <label className="font-bold text-primary font-code-metric text-xs flex items-center gap-1.5">
                    <Zap className="w-3.5 h-3.5" /> KOLOM 1: EVENT 1 (Otomatis Saat Pesan Masuk)
                  </label>
              ...
              <div className="p-3.5 rounded-lg bg-surface-container-low border border-outline-variant/30 space-y-2">
                <div className="flex items-center gap-1.5 text-on-surface font-code-metric text-xs font-bold">
                  ...
                  <span>KOLOM EVENT 2, 3, &amp; 4 (Dipilih Manual per Nomor)</span>
                </div>
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-outline-variant/20">
                <button
                  type="button"
                  onClick={() => setShowSettingsModal(false)}
                  className="px-4 py-2 rounded-lg bg-surface-container text-on-surface hover:bg-surface-container-high transition-colors cursor-pointer"
                >
                  Batal
                </button>
                <button
                  ...
                  className="px-5 py-2 rounded-lg bg-primary-container text-on-primary-container font-semibold hover:bg-primary transition-all flex items-center gap-1.5 cursor-pointer shadow-sm"
                >
      ...
      {showSimulateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm p-4">
          <div className="w-full max-w-md rounded-xl bg-surface-container-lowest border border-outline-variant/50 p-6 space-y-4 shadow-2xl">
            <div className="flex items-center justify-between pb-2 border-b border-outline-variant/20">
              <div className="flex items-center gap-2 text-primary">
            ...
            <form onSubmit={handleSimulateInbound} className="space-y-3.5 text-xs">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full p-2 rounded bg-surface-container border border-outline-variant/50 text-on-surface text-xs focus:border-primary focus:outline-none"
                />
              </div>
          ...
          <div className="w-full max-w-sm rounded-xl bg-surface-container-lowest border border-outline-variant/50 p-6 space-y-4 shadow-2xl">
            ...
            <div className="flex justify-end gap-2 pt-3 border-t border-outline-variant/20">
              <button
                type="button"
                onClick={() => setShowPurchaseModal(null)}
                className="px-4 py-2 rounded-lg bg-surface-container text-on-surface hover:bg-surface-container-high transition-colors cursor-pointer text-xs"
              >
                Batal
              </button>
              <button
                ...
                className="px-5 py-2 rounded-lg bg-tertiary-container hover:bg-tertiary text-on-tertiary-container font-semibold transition-all flex items-center gap-1.5 cursor-pointer text-xs shadow-sm"
              >
                ...
                <span>Kirim Purchase (Event {purchaseEventIndex}) ke Meta</span>
              </button>
            </div>
          </div>
        </div>
